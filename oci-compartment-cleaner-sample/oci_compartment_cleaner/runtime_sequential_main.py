...
from .runtime_backup_flow import log_resource_manager_backup_dry_run, prompt_for_delete, create_resource_manager_backup_before_deletion
...
def main() -> int:
    ...
    try:
        ...
        if prompt_for_delete(ordered, logger):
